...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_form_description_input = page.get_by_test_id('create-course-form-description-input').locator('input')
        self.create_course_form_estimated_time_input = page.get_by_test_id(
            'create-course-form-estimated-time-input').locator('textarea').first
        self.create_course_form_max_score_input = page.get_by_test_id('create-course-form-max-score-input').locator('input')
        self.create_course_form_mix_score_input = page.get_by_test_id('create-course-form-mix-score-input').locator('input')
    ...
    def chek_visible_course_title(self):
    ...
    def chek_disabled_create_course_button(self):
        expect(self.create_course_button).to_be_disabled()

    def chek_visible_preview_empty_view(self):
    ...
    def chek_visible_preview_upload_view(self, is_image_upload: bool = False):
    ...
    def chek_visible_preview_image(self):
        expect(self.preview_image).to_be_visible()
       
    def upload_rpreview_imadge(self, file: str):
        self.preview_image_upload_input.set_input_files(file)


    def chek_visible_create_course_form(self, 
            title: str,
            estimated_time: str,
            description: str,
            max_score: str,
        ...
        expect(self.create_course_form_estimated_time_input).to_have_value(
            estimated_time
            )

        expect(self.create_course_form_description_input).to_be_visible()
        expect(self.create_course_form_description_input).to_have_value(
            description)
        ...
        expect(self.create_course_form_mix_score_input).to_be_visible()
        expect(self.create_course_form_mix_score_input).to_have_value(mix_score)
    ...
    def hek_visible_create_exercise_button(self):
        expect(self.create_exercise_button).to_be_visible()
       
    def click_create_exercise_button(self):
        expect(self.create_exercise_button).to_be_visible()
        
    def chek_exercises_empty_view(self):
    ...
    def chek_visible_create_exercise_form(self, index: int, title: str, description: str):
        exercise_titel = self.page.get_by_test_id(
            f'create-course-exercise-{index}-box-toolbar-subtitle-text'
        )
        exercise_titel_input = self.page.get_by_test_id(
        ...
        expect(exercise_titel).to_be_visible()
        expect(exercise_titel).to_have_text(f'#{index} Exercise')

        expect(exercise_titel_input).to_be_visible()
        expect(exercise_titel_input).to_have_text(title)
    ...
    def fill_create_exercise_form(self, index: int, title: str, description: str):
        ...
        exercise_titel_input.fill(title)
        expect(exercise_titel_input).to_have_text(title)
